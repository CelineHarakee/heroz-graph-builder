...
async function main() {
    ...
    try {
        ...
        console.log("========================================");
        console.log("STEP 15E-D - REAL FOUR-FACTOR INTEGRATION");
        console.log("========================================");
        console.log("");
        ...
        console.log("");
        console.log("Exploration source state:");
        ...
        console.log("");
        console.log("========================================");
        console.log("STEP 15E-D REAL FOUR-FACTOR INTEGRATION PASSED");
        console.log("========================================");
...
main()
    ...
    .catch((error) => {
        console.error("STEP 15E-D REAL FOUR-FACTOR INTEGRATION FAILED");
        console.error(error);
        process.exit(1);
    });
